...
public class Test2Form extends JFrame {
...
//	private JLabel accentLabel;
	...
	public Test2Form() throws HeadlessException {
		super("Pronunciation Test");
		install();
...
//		numAccent = (numAccent == 1) ? 0 : 1;
		...
		for (int i = 0; i < textButton.length; i++)
			textButton[i] = words[i].getAccents()[numAccent];

		setTextButton(textButton);
//		accentLabel.setText(mes);
		translateLabel.setText(words[0].getTranslate());
		wordLabel.setText(words[0].getWordOrigin());
	}
